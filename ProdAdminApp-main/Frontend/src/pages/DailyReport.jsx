...
const DailyReport = () => {
  ...
  const isReportComplete = (formData) => {
  return (
    formData.childName &&
    formData.inTime &&
    formData.outTime &&
    formData.snack &&
    formData.meal &&
    (formData.sleepNot || (formData.sleepFrom && formData.sleepTo)) &&
    (formData.noDiaper
      ? formData.toiletVisits !== ''
      : formData.diaperChanges !== '') &&
    formData.poops !== '' &&
  ...
  const reportData = {
    ...
    date: new Date(),
    status: isReportComplete(formData) ? 'complete' : 'partial', // ✅ added here
  };
